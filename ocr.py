...
_url = 'http://westus.api.cognitive.microsoft.com/vision/v1.0/ocr?%s'
_key = "95e7401de1c3441d8b842729f9090862"
_maxNumRetries = 10
...
def getter(data):
    '''
    pathToFileInDisk = '/home/shreyas/opencv/Practice/'
    ...
    operationLocation = dict(processRequest(json, data, headers, params))

    print type(operationLocation)
    bf.printer(operationLocation)
